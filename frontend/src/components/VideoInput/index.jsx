...
import { Link2, Youtube, Video, AlertCircle, Loader2 } from 'lucide-react'
    ...
    <div className="space-y-3">
      <div className="relative">
        ...
        <input
          ...
          placeholder="Paste YouTube or Gumlet video URL..."
          value={value || ''}
      ...
      {videoInfo?.url && (
        <VideoPlayer videoUrl={videoInfo.url} videoSource={videoInfo.source} title="Preview" />
      )}
    </div>
  )
}
