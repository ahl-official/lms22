...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .flashcard { display: flex; flex-direction: column; gap: 0; border: 1px solid #e5e7eb; border-radius: 10px; overflow: hidden; margin-bottom: 10px; page-break-inside: avoid; }
  ...
  .flashcard-a .label { background: #a5b4fc; color: #fff; }
...
${checklistHtml}
${keyPointsHtml}
${flashcardsHtml.length ? `<section><h2>Flashcards</h2>${flashcardsHtml}</section>` : ''}
